...
- :py:class:`~keystoneauth1.identity.v3.WebSSOOpenIDConnect`: OpenID Connect
  Web SSO authentication using browser-based login flow.
...
- v3websso: :py:class:`keystoneauth1.identity.v3.WebSSOOpenIDConnect`
